    ...
    override fun onClick(v: View?) {
        when(v?.id){
            R.id.containedButton1-> {
                ...
                Toast.makeText(applicationContext, "botoncontenido1", Toast.LENGTH_LONG).show()
            }
            R.id.containedButton->{
                //val intent=Intent(this,Buttons::class.java)
                Toast.makeText(applicationContext, "botóncontenido", Toast.LENGTH_LONG).show()
            }
            R.id.outlinedButtonWithIcon1->{
                //val intent=Intent(this,Buttons::class.java)
                Toast.makeText(applicationContext, "BotóndelineadoConIcono1", Toast.LENGTH_LONG).show()
            }
            R.id.outlinedButtonWithIcon->{
                //val intent=Intent(this,Buttons::class.java)
                Toast.makeText(applicationContext, "BotóndelineadoConIcono", Toast.LENGTH_LONG).show()
            }
            R.id.textButton1->{
                // val intent=Intent(this,Buttons::class.java)
                Toast.makeText(applicationContext, "boton de texto 1", Toast.LENGTH_LONG).show()
            }
            R.id.textButton->{
                //val intent=Intent(this,Buttons::class.java)
                Toast.makeText(applicationContext, "boton de texto", Toast.LENGTH_LONG).show()
            }
            R.id.button1->{
                //val intent=Intent(this,Buttons::class.java)
                Toast.makeText(applicationContext, "boton1", Toast.LENGTH_LONG).show()
            }
            R.id.button2->{
                //val intent=Intent(this,Buttons::class.java)
                Toast.makeText(applicationContext, "boton2", Toast.LENGTH_LONG).show()
            }
            R.id.button3-> {
                //val intent = Intent(this, Buttons::class.java)
                Toast.makeText(applicationContext, "boton3", Toast.LENGTH_LONG).show()
            }
        }   }
}